...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($name) || empty($email) || empty($subject) || empty($message)) {
        ...
        $success_message = "Your question has been submitted successfully. A librarian will respond to you shortly.";
    }
}
?>
...
<head>
    ...
    <title>Ask a Librarian - Pan Pacific University Library</title>
...
<body class="bg-gray-50">
    ...
    <div class="container mx-auto px-4 py-8">
        <div class="max-w-2xl mx-auto">
            <h2 class="text-3xl font-bold mb-8">Ask a Librarian</h2>
            ...
            <div class="bg-white rounded-xl shadow-md p-6 mb-8">
                <p class="text-gray-600 mb-6">
                    Need help with research or have questions about library services? Our librarians are here to help!
                ...
                <form method="POST" class="space-y-6">
                    ...
                    <div>
                        ...
                        <select id="subject" name="subject" required
                            ...
                            <option value="resources">Library Resources</option>
            ...
            <div class="bg-blue-50 rounded-lg p-6">
                ...
                <div class="space-y-4">
                    <div class="flex items-start">
                        ...
                        <div>
                            <p class="font-medium">Live Chat Hours</p>
